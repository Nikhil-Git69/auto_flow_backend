...
const getAllWorkspaces = async (req, res) => {
    try {
        const userId = req.user.userId;
        const workspaces = await Workspace_1.default.find({ members: userId })
