...
router.post("/upload-file", (req, res) => {
    upload.fields([
        ...
        try {
            ...
            const analysisResult = await (0, aiAnalysisService_1.analyzeDocumentWithAI)(documentFile.buffer, documentFile.originalname, documentFile.mimetype, formatType, formatRequirements, templateFile);
            ...
            const analysis = new Analysis_1.default({
                analysisId: `analysis-${(0, uuid_1.v4)()}`,
